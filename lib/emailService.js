...
function buildParentInvitationPayload(invitationLink, inviterName, childName, partnerAppUrl, enactEmailExists = false) {
...
${invitationLink}`;
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p>Accepting this invitation allows your child's teacher to view Language Development data from home, and allows you to view Language Development data from the classroom.</p>
                            ${enactReadyLine}
                            ${middleHtml}
    ...
    const textContent = `
                ...
                Accepting this invitation allows your child's teacher to view Language Development data from home, and allows you to view Language Development data from the classroom.
